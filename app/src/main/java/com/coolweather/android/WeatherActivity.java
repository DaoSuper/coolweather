...
public class WeatherActivity extends AppCompatActivity {
    ...
    private HourlyAdapter hourlyAdapte;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rv_hourly.addItemDecoration(new SpaceItemDecoration(40, 0));
    ...
    public void showWeatherInfo(Weather weather) {
        ...
        titleUpdateTime.setText("数据更新时间：" + updateTime);
        degreeText.setText(degree);
        weatherInfoText.setText(weatherInfo);
        hourlyAdapte = new HourlyAdapter(weather.hourliesList);
        rv_hourly.setAdapter(hourlyAdapte);
